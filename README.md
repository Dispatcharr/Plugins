...
| [`reservoarr`](#reservoarr) | `6.3.5` | brko7 | MIT | Delay-buffer stream profile that absorbs IPTV CDN gaps so Plex Live TV stops dying |
...
**Downloads:**
- [Latest Release (`6.3.5`)](https://github.com/Dispatcharr/Plugins/releases/download/reservoarr-6.3.5/reservoarr-6.3.5.zip)
- [All Versions (8 available)](./metadata/reservoarr)

**Maintainers:** brko7 | **Source:** [Browse](https://github.com/Dispatcharr/Plugins/tree/main/plugins/reservoarr) | [README](https://github.com/Dispatcharr/Plugins/blob/main/plugins/reservoarr/README.md) | **Last Change:** [`546efce`](https://github.com/Dispatcharr/Plugins/commit/546efce68aa487777c3fbe2d4eaa6abc18a80eeb)
...
*Last updated: Sep 14 2026, 08:44 UTC*
